...
class Frame_Envelope_Plot:
    ...
    def __init__(self, window, gui):
        ...
        self.label = tk.Label(master=self.frame_envelope_plot, text=' Envelope: ', fg="blue", font=('Sans', '8', 'bold'))
        self.label.grid(column=0, row=0)
        self.envelope_btn = tk.Button(master=self.frame_envelope_plot, text=" Change envelope ", command=self.changeEnvelope, bg="#669999", font=('Sans', '8', 'bold'))
        self.envelope_btn.grid(column=1, row=0)
        self.label_envelope = tk.Label(master=self.frame_envelope_plot, text='None', fg="#ff6600", font=('Sans', '8', 'bold'), borderwidth=2, relief="ridge")
        ...
        self.label = tk.Label(master=self.frame_envelope_plot, text=' CMAP:', fg="blue", font=('Sans', '8', 'bold'))
