...
class Frame_Pure_Hydrogen:
    ...
    def __init__(self, window, gui):
        ...
        self.mass_radius_check = tk.Checkbutton(master=self.frame_pure_hydrogen, text="Show pure-Hydrogen mass-radius?", variable=self.mass_radius_check_var, fg="#cc3300", font=('Sans', '8', 'bold'))
        self.mass_radius_check.grid(column=0, row=0)
        self.central_density_check_var = tk.IntVar()
        self.central_density_check = tk.Checkbutton(master=self.frame_pure_hydrogen, text="Show pure-Hydrogen central density?", variable=self.central_density_check_var, fg="#cc3300", font=('Sans', '8', 'bold'))
