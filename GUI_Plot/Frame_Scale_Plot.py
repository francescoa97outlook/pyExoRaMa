...
class Frame_Scale_Plot:
    ...
    def __init__(self, window, gui):
        ...
        self.mass_label_scale = tk.Label(master=self.frame_scale_plot, text='Log', fg="#ff6600", font=('Sans', '9', 'bold'), borderwidth=2, relief="ridge")
        ...
        self.radius_label_scale = tk.Label(master=self.frame_scale_plot, text='Log', fg="#ff6600", font=('Sans', '9', 'bold'), borderwidth=2, relief="ridge")
        self.radius_label_scale.grid(column=2, row=1)
        self.label = tk.Label(master=self.frame_scale_plot, text=' R⊕ min: ', fg="red", font=('Sans', '9', 'bold'))
        ...
        self.label = tk.Label(master=self.frame_scale_plot, text=' R⊕ max: ',  fg="red", font=('Sans', '9', 'bold'))
